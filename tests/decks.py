# from tensorflow.keras.preprocessing.sequence import pad_sequences as pad_sequences
...
decks = [['Giada, Font of Hope', 0],
         ['Norin the Wary', 0]]


for deck in decks:
    db = Deckbuilder(deck[0], budget=deck[1], model_name='adjusted_binary_small_testing_model', card_weight=0.3)
    db.build_deck()